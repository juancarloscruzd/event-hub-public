...
describe("Listener", function() {
    ...
    it("should pass the message to a message handler", function(done) {
		...
		testListener.init();
    	testListener.invokeMessageHandler(event, "myMessageHandler").then( function() {
    ...
    it("should handle an array of messages", function(done) {
		...
		testListener.init();
    	testListener.handleMessages(events, "myMessageHandler").then( function() {
    ...
    it("should check for messages on the given queue", function(done) {
		...
		testListener.init();
    	testListener.checkForMessages( "myQueueUrl").then( function() {
    		expect(done1).toBeTruthy()
    		done();
    	}).catch(function(e){
    		console.log(e);
